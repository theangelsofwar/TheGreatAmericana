...
namespace AmazonImages\GeoIp2\WebService;

use AmazonImages\GeoIp2\Exception\AddressNotFoundException;
use AmazonImages\GeoIp2\Exception\AuthenticationException;
use AmazonImages\GeoIp2\Exception\GeoIp2Exception;
use AmazonImages\GeoIp2\Exception\HttpException;
use AmazonImages\GeoIp2\Exception\InvalidRequestException;
use AmazonImages\GeoIp2\Exception\OutOfQueriesException;
use AmazonImages\GeoIp2\ProviderInterface;
use AmazonImages\MaxMind\WebService\Client as WsClient;
...
class Client implements ProviderInterface
{
    ...
    private function responseFor($endpoint, $class, $ipAddress)
    {
        ...
        } catch (\AmazonImages\MaxMind\Exception\IpAddressNotFoundException $ex) {
            throw new AddressNotFoundException(
                $ex->getMessage(),
                $ex->getStatusCode(),
                $ex
            );
        } catch (\AmazonImages\MaxMind\Exception\AuthenticationException $ex) {
            throw new AuthenticationException(
                $ex->getMessage(),
                $ex->getStatusCode(),
                $ex
            );
        } catch (\AmazonImages\MaxMind\Exception\InsufficientFundsException $ex) {
            throw new OutOfQueriesException(
                $ex->getMessage(),
                $ex->getStatusCode(),
                $ex
            );
        } catch (\AmazonImages\MaxMind\Exception\InvalidRequestException $ex) {
        ...
        } catch (\AmazonImages\MaxMind\Exception\HttpException $ex) {
        ...
        } catch (\AmazonImages\MaxMind\Exception\WebServiceException $ex) {
        ...
        $class = 'AmazonImages\\GeoIp2\\Model\\' . $class;
