 ...
 */
namespace AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\api;

use AmazonImages\GuzzleHttp\ClientInterface;
use AmazonImages\GuzzleHttp\Exception\RequestException;
use AmazonImages\GuzzleHttp\Psr7\MultipartStream;
use AmazonImages\GuzzleHttp\Psr7\Request;
use AmazonImages\GuzzleHttp\RequestOptions;
...
use AmazonImages\Amazon\ProductAdvertisingAPI\v1\HeaderSelector;
use AmazonImages\Amazon\ProductAdvertisingAPI\v1\ObjectSerializer;
use AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SignHelper;
use AmazonImages\GuzzleHttp\Exception;
...
class DefaultApi
{
     ...
     *
     * @param  \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesRequest $getBrowseNodesRequest GetBrowseNodesRequest (required)
     *
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse
     */
     ...
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrowseNodesWithHttpInfo($getBrowseNodesRequest)
    {
        $returnType = '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse';
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIClientException',
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIServiceException',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @throws \InvalidArgumentException
     * @return \AmazonImages\GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @return \AmazonImages\GuzzleHttp\Psr7\Request
     */
    protected function getBrowseNodesRequest($getBrowseNodesRequest)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \AmazonImages\GuzzleHttp\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \AmazonImages\GuzzleHttp\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \AmazonImages\GuzzleHttp\Psr7\build_query($formParams);
            }
        }
        ...
        $query = \AmazonImages\GuzzleHttp\Psr7\build_query($queryParams);
        return new Request(
            'POST',
     ...
     * Operation getItems
     *
     * @param \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsRequest $getItemsRequest GetItemsRequest (required)
     *
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse
     */
     ...
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsWithHttpInfo($getItemsRequest)
    {
        $returnType = '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse';
     ...
     *
     * @param \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsRequest $getVariationsRequest GetVariationsRequest (required)
     *
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse
     */
     ...
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationsWithHttpInfo($getVariationsRequest)
    {
        $returnType = '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse';
     ...
     *
     * @param \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsRequest $searchItemsRequest SearchItemsRequest (required)
     *
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse
     */
     ...
     * @throws \AmazonImages\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchItemsWithHttpInfo($searchItemsRequest)
    {
        $returnType = '\AmazonImages\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse';
