...
namespace AmazonImages\ApaiIO\Configuration;

use AmazonImages\ApaiIO\Request\RequestInterface;
use AmazonImages\ApaiIO\ResponseTransformer\ResponseTransformerInterface;
