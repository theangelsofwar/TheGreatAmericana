...
namespace AmazonImages\ApaiIO\Request;

use AmazonImages\ApaiIO\ApaiIO;
use AmazonImages\ApaiIO\Configuration\ConfigurationInterface;
use AmazonImages\ApaiIO\Operations\OperationInterface;
use AmazonImages\GuzzleHttp\ClientInterface;
use AmazonImages\GuzzleHttp\Psr7\Uri;
...
class GuzzleRequest implements RequestInterface
{
    ...
    public function perform(OperationInterface $operation, ConfigurationInterface $configuration)
    {
        ...
        $request = new \AmazonImages\GuzzleHttp\Psr7\Request('GET', $uri->withScheme($this->scheme), [
